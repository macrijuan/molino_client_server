...
const router = Router();
const { tableValidator, yearValidator, monthValidator, dayValidator, timeValidator, userOwnerValidator }=require("../validation.js");
const { isMandatory } = require("../../../errors.js");
